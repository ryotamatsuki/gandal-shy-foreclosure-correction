...
For part 3, the cost-floor game imposes $p_1,p_2\geq0$ and $p_3\geq c$. Intersect U1 with $r\geq c$. Since U1 also requires $r=s+1$ and $c\geq s+1$, both inequalities bind: $r=c=s+1$, so $s=c-1$. The conditions $3/2\leq s<2$ give $5/2\leq c<3$. Intersect U2 with $r\geq c$: the member price remains $2$, while the outsider may choose any $r\geq c$ for $c\geq3$. Restricting to $5/2<c<5$ yields \eqref{eq:piecewise-price}.
\end{proof}
